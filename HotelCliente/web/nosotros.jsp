<%-- 
    Document   : nosotros
    Created on : 08-jul-2024, 13:25:21
    Author     : Usuario
--%>
    ...
    <div class="text-center page">
          ...
          <nav class="rd-navbar rd-navbar-default-with-top-panel" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-md-layout="rd-navbar-fullwidth" data-md-device-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-fullwidth" data-lg-device-layout="rd-navbar-fullwidth" data-md-stick-up-offset="90px" data-lg-stick-up-offset="150px" data-stick-up="true" data-sm-stick-up="true" data-md-stick-up="true" data-lg-stick-up="true">
            ...
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-panel">
                ...
                <!-- RD Navbar Brand-->
                <div class="rd-navbar-brand mobile-brand"><a class="brand-name" href="Inicio.jsp"><img src="images/logo-default-314x48.png" alt="" width="314" height="48"/></a></div>
              </div>
                ...
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-nav-scroll-holder">
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="active"><a href="nosotros.jsp">NOSOTROS</a>
                      </li>
          ...
          <div class="range range-50 range-md-justify range-sm-middle">
            <div class="cell-sm-6 wow fadeInUp" data-wow-delay=".1s">
              <div class="box-outline box-outline__mod-1">
                <figure><img src="images/about-01.jpg" alt="" width="546" height="516"/>
                </figure>
              </div>
            </div>
            <div class="cell-sm-6 cell-md-5 wow fadeInUp" data-wow-delay=".2s">
              <h3>Algunas palabras sobre nosotros</h3>
              <p>¿Estás cansado de tu rutina diaria? ¿Buscas un lugar para quedarte y descansar con tu familia? Estás en el lugar correcto! Nuestro resort y hotel con spa ofrece alojamiento histórico y de lujo para los viajeros. Combina estilo moderno y comodidades con valores tradicionales.</p>
              <p>Todas las habitaciones están equipadas con aire acondicionado y televisores LCD. El servicio WI-FI gratuito está disponible en todo el territorio del hotel. La comida de nuestro restaurante y las comidas de cocinas mundiales unen a personas que conectan historia y tradiciones. ¡Experimente nuestra cálida hospitalidad, alta calidad de servicio y comodidad excepcional! ¡Haga una reserva para las vacaciones de sus sueños hoy!</p><a class="button button-primary button button-square button-effect-ujarak button-lg" href="#"><span>Conocenos</span></a>
            </div>
          </div>
        </div>
      </section>
      <section class="section section-md">
        <div class="shell">
          ...
          <p>Royal Villas ofrece las mejores habitaciones con diseños únicos que brindan un ambiente lujoso y relajante.<br> Las telas y acabados especialmente seleccionados varían de una habitación a otra, ofreciendo a los huéspedes una variedad de atmósferas hermosas y únicas para elegir.</p>
          <div class="range range-30" data-lightgallery="group">
            <div class="cell-sm-6 cell-md-4"><a class="thumbnail-classic" href="images/grid-gallery-1-1200x800_original.jpg" data-lightgallery="item">
                <figure><img src="images/grid-gallery-5.jpg" alt="" width="370" height="276"/>
                </figure>
                <div class="caption">
            ...
            <div class="cell-sm-6 cell-md-4"><a class="thumbnail-classic" href="images/grid-gallery-2-1200x800_original.jpg" data-lightgallery="item">
                <figure><img src="images/grid-gallery-2.jpg" alt="" width="370" height="276"/>
                </figure>
                <div class="caption">
            ...
            <div class="cell-sm-6 cell-md-4"><a class="thumbnail-classic" href="images/grid-gallery-3-1058x800_original.jpg" data-lightgallery="item">
                <figure><img src="images/grid-gallery-3.jpg" alt="" width="370" height="276"/>
                </figure>
                <div class="caption">
            ...
            <div class="cell-sm-6 cell-md-4"><a class="thumbnail-classic" href="images/grid-gallery-4-1200x797_original.jpg" data-lightgallery="item">
                <figure><img src="images/grid-gallery-4.jpg" alt="" width="370" height="276"/>
                </figure>
                <div class="caption">
            ...
            <div class="cell-sm-6 cell-md-4"><a class="thumbnail-classic" href="images/grid-gallery-6-1200x800_original.jpg" data-lightgallery="item">
                <figure><img src="images/grid-gallery-6.jpg" alt="" width="370" height="276"/>
                </figure>
                <div class="caption">
