<%-- 
    Document   : contacto
    Created on : 08-jul-2024, 13:25:33
    Author     : Usuario
--%>
                ...
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-nav-scroll-holder">
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="active"><a href="contacto.jsp">CONTACTO</a>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div class="range range-50 range-md-center">
              <div class="cell-sm-8">
                <div class="contact-box">
                  ...
                  <p>Estamos disponibles 24 horas al día, 7 días a la semana por fax, correo electrónico o teléfono. También puede utilizar nuestro formulario de contacto rápido para hacer una pregunta sobre nuestros servicios. Estaremos encantados de responder a sus preguntas.</p>
                    ...
                    <div class="range range-sm-bottom spacing-20">
                      ...
                      <div class="cell-sm-6">
                        <div class="form-wrap">
                          ...
                          <label class="form-label" for="contact-last-name">Telefono</label>
                        </div>
                      </div>
              ...
              <div class="cell-sm-4">
                <aside class="contact-box-aside text-left">
                  <div class="range range-50">
                    ...
                    <div class="cell-xs-6 cell-sm-12">
                      <p class="aside-title"> Horario de abertura</p>
                      <hr class="divider divider-left divider-custom">
                      <div class="unit unit-middle unit-horizontal unit-spacing-xs unit-xs-top">
                        ...
                        <div class="unit__body text-gray-darker">
                          <p>Trabajamos todo el dia 9:00–23:00</p>
                        </div>
                      </div>
                    </div>
                  </div>
