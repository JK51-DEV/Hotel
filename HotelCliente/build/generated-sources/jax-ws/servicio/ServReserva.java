...
public interface ServReserva {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "buscarReservaDNIprueba", targetNamespace = "http://servicio/", className = "servicio.BuscarReservaDNIprueba")
    @ResponseWrapper(localName = "buscarReservaDNIpruebaResponse", targetNamespace = "http://servicio/", className = "servicio.BuscarReservaDNIpruebaResponse")
    @Action(input = "http://servicio/ServReserva/buscarReservaDNIpruebaRequest", output = "http://servicio/ServReserva/buscarReservaDNIpruebaResponse")
    public String buscarReservaDNIprueba(
